      ...
      <div className="flex flex-col gap-8 pb-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2">
            ...
            {lastOrders.length === 0 ? (
              <Card padding="lg" className="bg-[var(--color-app-panel)] border-[var(--color-app-border)] text-center py-8">
                <p className="text-sm text-[var(--color-app-text-muted)]">No transactions recorded yet.</p>
              </Card>
            ) : (
              <>
                {/* Desktop Table View */}
